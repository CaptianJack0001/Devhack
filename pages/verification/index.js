...
export default class Registration extends React.Component {
  ...
  renderUnverifiedVoters = (voter) => {
    ...
    return (
      <>
        {voter.isVerified ? (
          <div className="container-list card m-3 my-8 bg-primary bg-base-100 text-primary-content shadow-xl">
            <p style={{ margin: '7px 0px' }}>AC: {voter.address}</p>
            <div className="overflow-x-auto">
              <table className="card-body table-compact table w-full">
                <tr>
                  <th>Name </th>
                  <th>Phone </th>
                  <th>Voted </th>
        ...
        <div
          className="container-list card my-8 mb-5 bg-neutral bg-base-100 text-neutral-content shadow-xl"
